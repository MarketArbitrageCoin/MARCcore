Contributing to Marcoin Core
==================================

The Marcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Marcoin Core project, and is not to be
confused with overall Marcoin Network Protocol consensus changes.

Whether a pull request is merged into Marcoin Core rests with the project merge
...
Patches that change Marcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Marcoin consensus, it must have been
...
The project leader is the release manager for each Marcoin Core release.
