...
public:
    CMainParams()
    {
        ...
        assert(hashGenesisBlock == uint256("0x0000043b8be3fff987f6b27edf365ecd65adc162da80a0efe66e0d5048a02f97"));  // www.genesisblock.eu
        assert(genesis.hashMerkleRoot == uint256("0x5040be248dfe5a0c1b5b4a2249cf234a79832bbea9db264588b4b6ef4e842d10"));

        vSeeds.push_back(CDNSSeedData("seed1", "s1.marcoin.cc"));  
        vSeeds.push_back(CDNSSeedData("seed2", "s2.marcoin.cc"));  
        vSeeds.push_back(CDNSSeedData("seed3", "s3.marcoin.cc"));     
        ...
        strSporkKey = "049a9743aefd973ea3d3b855a3c48709261dbb2d6918bf72257a470aa09b1ed7002794ddb66fa4850abddbf1d42ba25507dadcb4654171dea66469d1e9a4919287";
        strMasternodePoolDummyAddress = "Ml8VWUkt6HtSCY2SaJ2akeyJUg8bg1hW3S";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("0463646781c1e0908b18be8457507ce87a917b6fce7dc87bbe7b3c3b1e06367fae9de50351d7106fdff2dd4815c8490e1b06c8311d1779a56e225e8b0db2f8dbd3");
        nDefaultPort = 44014;
        ...
        strMasternodePoolDummyAddress = "hbJ4Qad4xc77PpLzMx6rUegAs6aUPWkcUq";
