...
/* Marcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Marcoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "Marcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Marcoin-Qt-testnet"
