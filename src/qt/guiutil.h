...
/** Utility functions used by the Marcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MARC addresses in monospace font
...
// Parse "marcoin:" URI into recipient object, return true on successful parsing
