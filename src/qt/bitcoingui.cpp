                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Marcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MARC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and marcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Marcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Marcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Marcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MARC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MARC addresses"));
    ...
    openAction->setStatusTip(tr("Open a marcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Marcoin Core help message to get a list with possible Marcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Marcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Marcoin network", "", count));
}
...
{
    QString strTitle = tr("Marcoin Core"); // default title
