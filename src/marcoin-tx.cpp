...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Marcoin Core marcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  marcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded marcoin transaction") + "\n" +
                               "  marcoin-tx [options] -create [commands]   " + _("Create hex-encoded marcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded marcoin transaction
