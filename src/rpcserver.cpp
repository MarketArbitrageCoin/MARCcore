...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Marcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Marcoin features */
        {"marcoin", "masternode", &masternode, true, true, false},
        {"marcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"marcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"marcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"marcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"marcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"marcoin", "startmasternode", &startmasternode, true, true, false},
        {"marcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"marcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"marcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"marcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"marcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"marcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"marcoin", "mnbudget", &mnbudget, true, true, false},
        {"marcoin", "preparebudget", &preparebudget, true, true, false},
        {"marcoin", "submitbudget", &submitbudget, true, true, false},
        {"marcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"marcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"marcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"marcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"marcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"marcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"marcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"marcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"marcoin", "mnsync", &mnsync, true, true, false},
        {"marcoin", "spork", &spork, true, true, false},
        {"marcoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"marcoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"marcoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"marcoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"marcoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"marcoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> marcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:44005/\n";
}
