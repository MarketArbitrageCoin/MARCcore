...
#   c) node1 mines 32 blocks, so now node 0 has 500000MARC, node 1 has 4250MARC, node2 has none.
#   d) node0 sends 601 MARC to node2, in two transactions (301 MARC, then 300 MARC).
