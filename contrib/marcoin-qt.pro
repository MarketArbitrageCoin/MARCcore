...
RESOURCES += src/qt/marcoin.qrc src/qt/marcoin_locale.qrc

TRANSLATIONS += src/qt/locale/marcoin_bg.ts \
                src/qt/locale/marcoin_de.ts \
                src/qt/locale/marcoin_en.ts \
                src/qt/locale/marcoin_es.ts \
                src/qt/locale/marcoin_fi.ts \
                src/qt/locale/marcoin_fr.ts \
                src/qt/locale/marcoin_it.ts \
                src/qt/locale/marcoin_ja.ts \
                src/qt/locale/marcoin_pl.ts \
                src/qt/locale/marcoin_pt.ts \
                src/qt/locale/marcoin_ru.ts \
                src/qt/locale/marcoin_sk.ts \
                src/qt/locale/marcoin_sv.ts \
                src/qt/locale/marcoin_vi.ts \
                src/qt/locale/marcoin_zh_CN.ts \
                src/qt/locale/marcoin_zh_TW.ts
