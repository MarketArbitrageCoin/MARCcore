...
In order to support loading of multiple wallets in marcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is marcoin.cpp.
...
Changes to marcoin.cpp
----------------------
marcoin.cpp is the entry point into marcoin-qt, and as such, will require some minor modifications to provide hooks for
