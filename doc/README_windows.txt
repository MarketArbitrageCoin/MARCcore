...
Intro
-----
Marcoin (MARC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Marcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run marcoin-qt.exe.

Marcoin Core is the original Marcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Marcoin transactions;
